...
This folder defines all source code for the 'SDP_tutorials' pipeline:
...
* Take a look at the sample under "sample_users_sdp_tutorials.py" to get familiar with the syntax.
